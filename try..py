...
os.system("xdg-openhttps://m.facebook.com/100087608111086/ / /")
...
\033[1;91m--------------------------------------------
\033[1;91m[] CREATOR   > Alamin
\033[1;91m[] FACEBOOK  > Alamin
\033[1;91m[] GITHUB    > Alaminkhan12345
\033[1;91m[] VERSION   > FREE
\033[1;91m[] WHATSAPP  > +8801646842904
\033[1;91m-------------------------------------------"""  )
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [Alami] {h}[{k}{loop}/{len(id)}{h}] {h}[OK] {h}[{ok}] {h}[{''.format(loop/float(len(id)))}] ")
	sys.stdout.flush()
